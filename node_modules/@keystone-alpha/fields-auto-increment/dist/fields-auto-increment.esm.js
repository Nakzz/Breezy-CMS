...
import { Implementation, Integer } from '@keystone-alpha/fields';
import { KnexFieldAdapter } from '@keystone-alpha/adapter-knex';

class AutoIncrementImplementation extends Implementation {
  constructor(path) {
    let config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    let context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}; // Apply some field type defaults before we hand off to super; see README.md
...
class KnexAutoIncrementInterface extends KnexFieldAdapter {
  ...
  addToForeignTableSchema(table, _ref) {
    let path = _ref.path,
        isUnique = _ref.isUnique,
        isIndexed = _ref.isIndexed,
        isNotNullable = _ref.isNotNullable;
