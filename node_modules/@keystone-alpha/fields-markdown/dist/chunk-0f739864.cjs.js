...
let getTools = cm => {
  ...
  let tools = [{
    ...
    label: 'Strikethrough',
    icon: () => React__default.createElement("s", {
      "aria-hidden": true
    }, "S"),
...
let ToolbarButton = React.forwardRef((props, ref) => {
...
let IconToolbarButton = _ref => {
  ...
  return core.jsx(Tooltip, {
    ...
    content: label
  }, ref => core.jsx(ToolbarButton, _extends({
    type: "button",
    css: {
      display: 'flex',
      justifyContent: 'center',
...
function MarkdownField(_ref2) {
  ...
  let toolbar = React.useMemo(() => {
    return core.jsx("div", {
      ...
      return core.jsx(IconToolbarButton, {
        key: tool.label,
        icon: core.jsx(tool.icon, null),
        onClick: onClick,
        label: tool.label
      });
    }));
  ...
  return core.jsx(fields.FieldContainer, {
    ...
    css: {
      border: "1px ".concat(theme.colors.N20, " solid"),
      borderRadius: theme.borderRadius,
      paddingBottom: theme.gridSize
    }
  }, toolbar, core.jsx(reactCodemirror2.Controlled, {
    value: value,
