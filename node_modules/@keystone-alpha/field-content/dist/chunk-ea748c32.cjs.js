...
let hasBlock = (editorState, type) => {
  return editorState.blocks.some(node => node.type === type);
};

let hasAncestorBlock = (editorState, type) => {
...
let getSelectionReference = () => {
  ...
  let getBoundingClientRect = () => {
    ...
    let nodeName = selection.anchorNode.nodeName;
    let range = !selection.rangeCount || nodeName === 'INPUT' || nodeName === 'TEXTAREA' ? lastRange : selection.getRangeAt(0);
...
exports.hasAncestorBlock = hasAncestorBlock;
exports.hasBlock = hasBlock;
exports.getSelectionReference = getSelectionReference;
