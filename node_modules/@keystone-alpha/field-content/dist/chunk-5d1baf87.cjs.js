...
let AddBlock = _ref => {
  ...
  let windowSize = __chunk_4.useWindowSize();
  ...
  let layout = React.useCallback(() => {
    ...
    if (!rect || rect.width !== 0 || focusBlock === null || focusBlock.text !== '' || focusBlock.type !== paragraph_js.type) {
      setIsOpen(false);
  ...
  __chunk_4.useScrollListener(layout);
...
function InnerToolbar(_ref) {
  ...
  }), core.jsx(__chunk_3.ToolbarButton, {
...
var Toolbar = _ref4 => {
  ...
  return core.jsx(reactPopper.Popper, {
    ...
    // editor references
    React.useMemo(__chunk_2.getSelectionReference, [])
  }, _ref5 => {
      ...
      normalize: (editor, _ref) => {
        ...
        switch (code) {
          case 'last_child_type_invalid':
            {
              const paragraph = slate.Block.create(paragraph_js.type);
