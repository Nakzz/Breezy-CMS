...
var Controller = _interopDefault(require('@keystone-alpha/fields/Controller'));
...
class ContentController extends Controller {
  constructor(config) {
    ...
    _defineProperty(this, "deserialize", data => {
      ...
      const blocks = this.getBlocksSync(); // TODO: Make the .document a JSON type in GraphQL so we dont have to parse
      // it
