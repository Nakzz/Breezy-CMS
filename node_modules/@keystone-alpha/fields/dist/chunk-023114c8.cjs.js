...
const StyledPreview = _ref => {
  ...
  return core.jsx(__chunk_3.PreviewPlaceholder, _extends({
    data: preview,
...
class OEmbedField extends React.Component {
  ...
  render() {
    const _this$props = this.props,
          ...
          savedValue = _this$props$savedValu === void 0 ? {} : _this$props$savedValu,
    ...
    return core.jsx(fields.FieldContainer, null, core.jsx(fields.FieldLabel, {
      ...
      id: htmlID
    })), value.originalUrl && hasChanged && core.jsx(PlaceholderPreview, {
      originalUrl: value.originalUrl,
      fieldPath: field.path
    }), value.originalUrl && !hasChanged && core.jsx(StyledPreview, {
